...
# rest of araguments
parser.add_argument('-c', '--content-topic', type=str, help='content topic', required=True)
parser.add_argument('-p', '--pubsub-topic', type=str, help='pubsub topic', required=True)
parser.add_argument('-s', '--msg-size-kbytes', type=int, help='message size in kBytes', required=True)
parser.add_argument('-d', '--delay-seconds', type=int, help='delay in second between messages', required=True)
